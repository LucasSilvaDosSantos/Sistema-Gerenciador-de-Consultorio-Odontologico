namespace Consultorio.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Consultorio.Data.ConsultorioContext>
    {
        ...
        protected override void Seed(Consultorio.Data.ConsultorioContext context)
        {
            ...
            //seed Cliente
            Cliente cliente1 = new Cliente("Ana Maria de Jesus", DateTime.Parse("16/02/1995"), "703.841.360-01", "41.976.260-7", "Ana@email.com", "(31) 9998-9535", "91234-5678", "Rua: perna longa", "Vila abc", "SP", "Campos do Jordão", "12460-000");
            Cliente cliente2 = new Cliente("José Roberto Silva", DateTime.Parse("01/02/2003"), "537.228.480-32", "", "jose@gmail.com", "(31) 91370-1903", "", "Rua: 123", "Vila 2", "SP", "Taubate", "12356-123");
            ...
            // seed consulta
            Consulta consulta1 = new Consulta(cliente1, DateTime.Parse("23/06/2019 12:00"), DateTime.Parse("23/06/2019 12:30"), procedimento1, procedimento1.Preco);
            Consulta consulta2 = new Consulta(cliente1, DateTime.Parse("24/06/2019 12:00"), DateTime.Parse("24/06/2019 12:30"), procedimento2, procedimento2.Preco);
            consulta1.Realizada = true;

            // seed Pagamentos
            Pagamento pagamento1 = new Pagamento(secretaria1, "Dinheiro", DateTime.Parse("24/06/2019 12:16"), 200.00, cliente1);
