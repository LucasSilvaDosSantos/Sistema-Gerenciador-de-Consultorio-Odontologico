namespace Consultorio.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Consultorio.Data.ConsultorioContext>
    {
        ...
        protected override void Seed(Consultorio.Data.ConsultorioContext context)
        {
            ...
            //seed Dentista
            Dentista dentista1 = new Dentista("Teste Dentista Sobrenome dentista", "Dentista@dentista.com", "Telefone1", "Telefone2", "Numero Crosp", "Logindentista", "Senha");
            ...
            // seed secretaria
            Secretaria secretaria1 = new Secretaria("Teste Secretaria Sobrenome Secretaria", "secretaria@secretaria", "Telefone1", "Telefone2", "Numero Crosp", "Loginsecretaria", "Senha",
                true, true, true, true);
